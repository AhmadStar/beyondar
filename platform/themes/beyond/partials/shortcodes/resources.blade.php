            ...
            <div class="col-xl-12">
                <div class="tp-blog-standard-thumb-box p-relative">
                    ...
                    <div class="tp-blog-standard-title-box d-none d-sm-block">
                        <h4 class="tp-blog-standard-title"><a
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mb-50">
                    ...
                    <div class="tp-blog-item">
                        ...
                        <div class="tp-blog-content">
                            <span> <a
                                    href="{{ $post->first_category->url }}">{{ $post->first_category->name }}</a></span>
...
<div class="tp-blog-list-area mt-30 mb-30">
    <div class="container container-1480">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="tm-hero-content">
                            ...
                            <h4 class="tm-hero-title-big">{{ $shortcode->news_title }}</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="tp-blog-standard-area pt-170">
            <div class="container container-1500">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="tp-blog-standard-thumb-box p-relative">
                            <img data-speed=".8" src="{{ RvMedia::getImageUrl($postN->image) }}"
                                alt="{{ $postN->name }}">
                            <div class="tp-blog-standard-title-box  d-sm-block">
                                <h4 class="tp-blog-standard-title"><a
                                        href="{{ $postN->url }}">{{ $postN->name }}</a></h4>
                            </div>
                            <div class="tp-blog-standard-meta d-none d-sm-block">
                                <span>
        ...
        <div class="tp-blog-list-wrap" style="margin-top: 5px;">
            @php
                $skipFirst = true;
            @endphp
                                ...
                                <div class="tp-blog-list-thumb anim-zoomin-wrap">
                                    <a href="#">
                                        <img class="anim-zoomin"
                                            src="{{ RvMedia::getImageUrl($post->image, 'medium') }}" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-5 col-md-5">
                            <div class="tp-blog-list-content tp-flex-column">
                                <div class="tp-blog-list-title-wrap">
                                    <h4 class="tp-blog-list-title-sm"><a
                                            href="{{ $post->url }}">{{ $post->name }}</a>
                                    </h4>
                                </div>
                                <p>{{ $post->description }}</p>
                                <div class="tp-blog-list-link-wrap">
                                    <a class="tp-blog-list-link" href="{{ $post->url }}">{{ __("Read More")}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
