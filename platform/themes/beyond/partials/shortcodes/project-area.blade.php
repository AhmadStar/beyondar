<div class="tp-service-3-area pt-130 pb-130">
    <div class="container">
        <div class="row">
            <div class="col-xl-9">
                <div class="tp-service-3-title-box mb-60 p-relative">
                    <div class="tp-service-3-icon">
                        <img src="/themes/beyond/img/home-03/service/sv-icon-1.png" alt="">
                    </div>
                           <span class="tp-section-subtitle-2 tp_fade_bottom">
                              ...
                              <span class="tp-subtitle-text tp_text_invert">Our approach</span>
                              <span>
                                 <svg width="13" height="44" viewBox="0 0 13 44" fill="none"
                                      xmlns="http://www.w3.org/2000/svg">
                                     <path
                    ...
                    <h4 class="tp-section-title-90 tp_text_invert tp_fade_bottom">News and Blogs</h4>
                </div>
            </div>
        </div>
        <?php
    ...
    {!! BaseHelper::renderIcon('ti ti-clock') !!} {{ Theme::formatDate($post->created_at) }}
        ...
        @endforeach
        <a class="tp-btn-black-2 tp_fade_bottom" href="/resources"
