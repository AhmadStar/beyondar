            ...
            <div class="col-xl-11">
                <div class="tp-about-3-title-box">
                           <span class="tp-section-subtitle-2 tp_fade_bottom">
                              ...
                              <span class="tp-subtitle-text tp_text_invert">{{$shortcode->title}}</span>
                              <span>
                                 <svg width="13" height="44" viewBox="0 0 13 44" fill="none"
                                      xmlns="http://www.w3.org/2000/svg">
                                     <path
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6 col-md-4">
                {{--<div class="tp-about-3-shape text-lg-end">--}}
                    {{--<img src="/themes/beyond/img/home-03/about/ab-shape-img.png" alt="">--}}
                {{--</div>--}}
                <img style="margin: 0 auto;    display: block;" src="/storage/general/V.1 (1).gif" alt="">
                {{--http://staging.beyondcreative.agency/storage/general/aykonat-llthryk-3-1.gif--}}
            </div>
            <div class="col-xl-6 col-lg-6 col-md-8">
                <div class="tp-about-3-content">
                    <p class="mb-30 mt-30 tp_fade_bottom">
                        {{$shortcode->text}}
                    </p>

                    <a class="tp-btn-black-2 tp_fade_bottom" href="{{$shortcode->url}}">
                        {{$shortcode->btn}}
