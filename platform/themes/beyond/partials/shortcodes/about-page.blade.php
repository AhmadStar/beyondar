        ...
        <a href="#about-info">
            <span>
                ...
                <svg width="15" height="30" viewBox="0 0 15 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M7.02322 30C7.02322 26.118 3.88198 22.9768 -4.06724e-05 22.9768" stroke="currentcolor"
                        stroke-width="1.5" stroke-miterlimit="10" />
                </svg>
            </span>
        </a>
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-5 col-md-4 mb-40">
                        <div class="ab-about-category-title-box p-relative">
                            <h4 class="ab-about-category-title">{{ __('Some of') }}
                                <br><span>{{ __('our services') }}</span></h4>
                            <br><img class="ab-about-shape-1 d-none d-md-block" src="/storage/general/shape-1.png"
                                alt="">
                        </div>
                    </div>
