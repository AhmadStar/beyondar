        ...
        <div class="row justify-content-center">
            <div class="col-xl-7">
                <div class="tp-project-3-title-box p-relative mb-150">
                    ...
                    {{--<h4 class="font-4 tp-section-title-200 tp_reveal_anim">--}}
                       {{__('Our')}}  <span>{{ $shortcode->title}}</span>
                    </h4>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="tp-project-3-thumb pro-img-1">
                                <img src="{{ RvMedia::getImageUrl($service->img1) }}" alt="">
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-12 order-1 order-lg-0">
                            <div class="tp-project-3-content text-center">

                                <h4 class="tp-project-3-title-sm"><a href="/service/{{$service->slug}}">{{$service->name}}</a></h4>
                                {{--<span class="tp-project-3-meta">{{$service->description}} </span>--}}
                                <a class="tp-btn-project-sm" href="/service/{{$service->slug}}">{{__('Explore More')}}</a>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 order-0 order-lg-0">
                            <div class="tp-project-3-thumb pro-img-2">
                                <img src="{{ RvMedia::getImageUrl($service->img2) }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
